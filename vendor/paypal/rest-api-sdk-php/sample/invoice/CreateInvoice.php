...
function createInvoice($clientId, $clientSecret)
{
    ...
    $clientId_ = 'AVc27xDn4TOP7CLg2qkQWPiaWpzphQHW2W0eyC4GinmD8PHxYZaJteWOKW9m';
    $clientSecret_ = 'EAjbuhD6IW3uMlKxN1EiI_VWoJZ0WW36dlE-oTg97yguFa4ZJoLuUQe5kbvG';

    printf($clientId."\n".$clientId_);
    printf($clientSecret."\n".$clientSecret_);

    $apiContext = getApiContext($clientId, $clientSecret);
    //printf("creds ".$apiContext);
